...
export function PersonalOverview({ snapshot }: PersonalOverviewProps) {
  return (
    <section className="grid animate-fade-in-up gap-3 pb-2 sm:gap-4">
      <Card className="relative rounded-none border-4 border-neo-dark bg-neo-bg p-4 text-neo-dark sm:p-5 md:p-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4">
        <Card className="rounded-none border-4 border-neo-dark bg-neo-bg p-3 text-neo-dark transition-all hover:-translate-y-1 hover:shadow-[4px_4px_0_#0F172A] active:scale-95 sm:p-4">
