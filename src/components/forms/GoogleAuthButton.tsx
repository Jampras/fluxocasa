...
export function GoogleAuthButton() {
  ...
  return (
    <div className="grid gap-4">
      <NeoButton type="button" disabled={pending} onClick={() => void handleGoogleAuth()} className="w-full py-4 text-2xl flex items-center justify-center gap-3 bg-neo-cream border-4 border-neo-dark hover:bg-neo-yellow text-neo-dark shadow-[4px_4px_0_#0F172A]">
