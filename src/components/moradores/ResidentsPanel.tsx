...
export function ResidentsPanel({ snapshot }: ResidentsPanelProps) {
  return (
    <section className="grid gap-4 animate-fade-in-up pb-10">
          ...
          return (
            <Card 
              ...
              className={isMe 
                ...
                : "bg-neo-bg border-4 border-neo-dark rounded-none p-4 flex flex-col hover:-translate-y-1 hover:shadow-[4px_4px_0_#0F172A] active:scale-95 transition-all text-neo-dark"
              }
            >
              <div className="flex items-center gap-3 sm:gap-5">
                ...
                <div className="flex-1 space-y-1">
                  <p className={`text-lg font-bold tracking-tight sm:text-xl ${isMe ? "text-neo-dark" : "text-neo-dark"}`}>
                    {resident.name}
                  </p>
      ...
      <div id="config-convite" className="mt-2 sm:mt-4">
        <InviteCodeActions
      ...
      <Card id="config-historico" className="rounded-none border-4 border-neo-dark bg-neo-bg p-4 sm:p-5">
