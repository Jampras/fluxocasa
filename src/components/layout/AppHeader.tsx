      ...
      <div className="flex items-start justify-between gap-3 border-b-[3px] border-neo-dark pb-3 sm:items-end sm:gap-4 sm:border-b-4 sm:pb-4">
        {isDashboard ? (
          <div className="flex flex-col overflow-visible pt-1">
            ...
            <h1 className="truncate font-heading text-4xl uppercase leading-[0.92] text-neo-dark sm:text-5xl md:text-[clamp(3.25rem,5.6vw,5.75rem)]">
              {userName}
            </h1>
          </div>
        ) : (
          <div className="flex flex-col overflow-visible pt-1">
            ...
            <h1 className="truncate font-heading text-3xl uppercase leading-[0.92] text-neo-dark sm:text-4xl md:text-[clamp(2.75rem,4.8vw,4.75rem)]">
              {title}
            </h1>
          </div>
        )}
